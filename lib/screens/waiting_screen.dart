...
class _WaitingScreenState extends State<WaitingScreen> {
  ...
  Widget _buildFallbackScreen(
    WaitingTimeController controller,
    ThemeData theme,
  ) {
    ...
    switch (errorType) {
      case "network":
        return FallbackScreen.noConnection(
          onRetry: () => controller.retryFetchRideDetails(),
      ...
      default:
        return FallbackScreen(
          ...
          message: controller.dataError.value ?? "Unable to load ride details",
      ...
      body: ValueListenableBuilder<bool>(
        ...
        builder: (context, isLoading, child) {
          return ValueListenableBuilder<String?>(
            valueListenable: _controller.dataError,
            builder: (context, error, child) {
              if (isLoading && _controller.rideDetails.value == null) {
                return Center(
                  child: Column(
              ...
              if (error != null) {
                return _buildFallbackScreen(_controller, theme);
              }

              final rideDetails = _controller.rideDetails.value;
              if (rideDetails == null) {
                return Center(
                  child: Text(
              ...
              return RefreshIndicator(
                onRefresh: () => _controller.refreshRideDetails(widget.rideId),
                          ...
                          children: [
                            ...
                            Text(
                              rideDetails.status.toLowerCase() == 'pending'
                                  ...
                                  : rideDetails.status.toLowerCase() ==
                                        'approved'
